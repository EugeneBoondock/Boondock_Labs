          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div id="websites" className="p-5 card-hover overflow-hidden rounded-xl scroll-mt-24">
              <div className="flex items-center mb-3">
                ...
                <h3 className="text-lg font-bold" style={{ color: '#c96442' }}>Website Development</h3>
              </div>
            ...
            <div className="p-5 card-hover overflow-hidden rounded-xl">
              <div className="flex items-center mb-3">
                ...
                <h3 className="text-lg font-bold" style={{ color: '#c96442' }}>Web Applications</h3>
              </div>
              <p className="text-sm text-black mb-2">
            ...
            <div className="p-5 card-hover overflow-hidden rounded-xl">
              <div className="flex items-center mb-3">
                ...
                <h3 className="text-lg font-bold" style={{ color: '#c96442' }}>Game Development</h3>
              </div>
              <p className="text-sm text-black mb-2">
            ...
            <div className="p-5 card-hover overflow-hidden rounded-xl">
              <div className="flex items-center mb-3">
                ...
                <h3 className="text-lg font-bold" style={{ color: '#c96442' }}>Metaverse & Scripts</h3>
              </div>
              <p className="text-sm text-black mb-2">
            ...
            <div className="p-5 card-hover overflow-hidden rounded-xl">
              <div className="flex items-center mb-3">
                ...
                <h3 className="text-lg font-bold" style={{ color: '#c96442' }}>AI & ML Integration</h3>
              </div>
              <p className="text-sm text-black mb-2">
            ...
            <div id="mcp" className="p-5 card-hover overflow-hidden rounded-xl scroll-mt-24">
              <div className="flex items-center mb-3">
                ...
                <h3 className="text-lg font-bold" style={{ color: '#c96442' }}>MCP Server Development</h3>
              </div>
              <p className="text-sm text-black mb-2">
            ...
            <div id="apis" className="p-5 card-hover overflow-hidden rounded-xl scroll-mt-24">
              <div className="flex items-center mb-3">
                ...
                <h3 className="text-lg font-bold" style={{ color: '#c96442' }}>API Development & Integration</h3>
              </div>
              <p className="text-sm text-black mb-2">
